...
# Store temporary params for /token flow
Param = {}
...
async def token_handler(client, message):
    """Handle the /start command with a fixed welcome image."""
    # Check subscription requirement
    join = await subscribe(client, message)
    if join == 1:
        return

    # Fixed welcome image URL
    image_url = "https://files.catbox.moe/x1wije.jpeg"

    # Build inline keyboard
    join_button = InlineKeyboardButton("Join Channel", url="https://t.me/vibeshiftbots")
    premium_button = InlineKeyboardButton("Get Premium", url="https://t.me/xyz09723")
    keyboard = InlineKeyboardMarkup([[join_button], [premium_button]])
